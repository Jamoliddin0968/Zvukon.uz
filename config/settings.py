...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Zvukon.uz Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Zvukon.uz",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Zvukon.uz",
    ...
    "welcome_sign": _("Zvukon.uz ga xush kelibsiz"),
    ...
    "icons": {
        ...
        "shop.Category": "far fa-file-alt",
        "shop.Image": "fas fa-image",
        "shop.Color": "fas fa-palette",
        "shop.Product": "fas fa-bars",
